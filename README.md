...
# 💻 Tech Stack
<!-- Ini Bagian Icon -->
[![My Skills](https://skillicons.dev/icons?i=anaconda,androidstudio,nginx,bootstrap,css,github,git,gmail,java,js,flutter,kotlin,nodejs,ae,html,htmx,ai,instagram,laravel,linkedin,notion,ps,php,powershell,pr,py,react,tailwind,ts,vercel,vscode,windows,wordpress,aiscript,alpinejs,figma&theme=dark)](https://skillicons.dev)
